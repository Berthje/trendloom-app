            ...
            <nav class="fixed top-0 right-0 h-full w-[22rem] bg-white overflow-auto p-8 text-center flex flex-col">
                ...
                <div v-else class="flex flex-col flex-grow">
                    <ul class="overflow-y-auto flex-grow">
                        <li v-for="(product, index) in products.slice(0, 4)" :key="index"
                            ...
                            <div>
                                <h4 class="leading-none mb-1">
                                    <RouterLink to="PRODUCT-DETAILS-PAGE">{{ product.title }}</RouterLink>
                                </h4>
                    ...
                    <p v-if="additionalProducts > 0" class="text-left mb-32 font-bold">..there {{ additionalProducts === 1 ? 'is' : 'are'}} {{ additionalProducts }} more product{{ additionalProducts > 1 ? 's' : '' }}</p>
                    <div>
